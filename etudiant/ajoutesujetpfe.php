...
?></td></tr>
<tr><td>Mot clé:</td> <td><input type="text" name="motcle" class="input_connexion"><?php
if(isset($erreur3)){
...
?>
<tr><td>Date Début: </td><td><input type="date" name="datedebut" class="input_connexion"><?php
if(isset($erreur5)){
	echo '<font color="red">' .$erreur5."</font>" ;

}
?></td></tr>
<tr><td>Date Fin: </td><td><input type="date" name="datefin" class="input_connexion"><?php
if(isset($erreur6)){
...
?></td></tr>
<tr><td>Anneé Universaire: </td><td><input type='text' name="anneeuniversaire" size="1" class="input_connexion">
</td>
...
?></td></tr>
<tr><td>2 eme Encadrant: </td><td><input type="text" name="encadrant2" class="input_connexion"><?php
...
<a href="pageetudiant.php"><img src="../image/retour.png" width="40px" height="40px"></a>
