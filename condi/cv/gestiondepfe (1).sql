...
--
-- Client: localhost
-- Généré le: Jeu 26 Mai 2016 à 21:44
...
(22, '../condi/cv/kln.txt', '../condi/att/Format9.2.docx', '../condi/lm/', 7953134);
...
INSERT INTO `enseignant` (`id`, `nom`, `prenom`, `cin`, `email`, `grade`, `departement`, `tel`, `adresse`, `active`) VALUES
(1, 'nida', 'madourie', 12345678, 'nidamadouri@gmail.com', 'maitre de conference', 'informatique', 20202020, 'beja', 'oui'),
(2, 'ramzi', 'guesmi', 11111111, 'ramziguesmi@gmail.com', 'technologue', 'informatique', 515, 'tunis', 'oui'),
(3, 'ramzi', 'farhat', 9876543, 'ramzifarhati@gmail.com', 'professeur', 'informatique', 456789, 'tunis', 'oui'),
(4, 'zied', 'guendil', 96385274, 'ziedguendir@gmail.com', 'technologue', 'informatique', 0, '', 'non'),
(9, 'bilel', 'maghraoui', 14785236, 'bilelmaghraoui@gmail.com', 'technologue', 'informatique', 547893212, '', 'non');
...
INSERT INTO `etudiant` (`id`, `nom`, `prenom`, `email`, `cin`, `datedenaissance`, `adresse`, `ville`, `tel`, `niveau`, `active`, `specialite`, `groupe`) VALUES
(6, 'mansour', 'namouchi', 'mansournamouchi@gmail.com', 4842367, '1993-03-17', 'hay zehour', 'tunis', 97381061, 3, 'oui', 'multimedia et web', 2),
(8, 'anouar', 'khemissi', 'khemissi08@hotmail.fr', 7953134, '1994-07-17', '01 rue feija citÃ© tahawel', 'ghardimaou', 54726323, 3, 'oui', 'multimedia et web', 1);
...
CREATE TABLE IF NOT EXISTS `sujetdestage` (
  ...
  `conception` varchar(25) NOT NULL,
  `competences` varchar(25) NOT NULL,
...
INSERT INTO `sujetdestage` (`id`, `titre`, `cahierdecharge`, `datedecreation`, `datefin`, `datedebut`, `objet`, `etat`, `societe`, `encadrant1`, `encadrant2`, `motcle`, `cinencadrant`, `cinproposeur`, `conception`, `competences`, `anneeuniversaire`, `type`) VALUES
(6, 'Developpement des modules', 'Gerer le referentiel des fournisseurs (creation, modification)\r\nGerer les commandes d achat a partir d une interface unifiee\r\nGerer la reception reception totale/partielle des commandes\r\nImprimer: bons de reception, factures, factures d avoir\r\nGenerer des rapports sous format Excel', '02-05-2016', '2016-05-23', '2016-01-21', 'Gerer le referentiel des fournisseurs', 'affecter', 'magasin general', 'nida madouri', 'nasri riabi', 'Gerer le referentiel ,Gerer les commandes d achat', 12345678, 7953134, 'uml', 'php', '2015-2016', 'pfe'),
(7, 'Developpement du module G', 'Gestion des parametres de la societe Gestion des articles (familles, sous-familles, categories) Gestion des clients (familles, sous-familles, types) Gestion des fournisseurs (familles, sous-familles, natures) Gestion des utilisateurs (droits d acces, mot de passe, alerte par mail) Gestion des banques, des codes postaux, des mois, des villes, etc. (import depuis des fichiers CSV)', '02-05-2016', '2016-05-23', '2016-01-22', 'Gestion des parametres de la societe', 'approuver', 'Agora informatique', 'nida ', 'oussama kahlaoui', 'ERP NEGOCE', 12345678, 12345678, 'merise', 'jsf', '2015-2016', 'ete'),
(8, 'Realisation d une platefo', 'ce stage est de porter cet outil de simulation vers un langage plus rapide. Dans un premier temps, le programme de simulation sera ecrit en langage C. Le gain en termes de temps de calcul sera alors evalue. Si nÃ©cessaire, une stratÃ©gie dâ€™implantation informatique parallÃ¨le (multithreading) sera etudiee afin de reduire encore les temps de calcul. Une fois le gain de temps dÃ©montrÃ© et suffisant pour permettre un affichage en temps rÃ©el, une GUI sera realisee afin de crÃ©er une plateforme de simulation.', '2016-05-21', '2016-05-19', '2016-01-14', 'La simulation d images medicales est utilisee comm', 'affecter', 'magazine', 'nida madouri', 'bayrem tounsi', 'simulation ', 12345678, 7953134, 'uml', 'jsf', '2015/2016', 'pfe'),
(9, 'Gestion des Stages et PFE', 'Postuler pour un ou plusieurs stages.\r\n	Consulter, editer et accÃ©der facilement aux informations relatives aux demandes et stages.\r\n	Gerer les etudiants et les enseignants.\r\n         Envoyer des candidatures spontanÃ©es\r\n	Gerer les sujets.', '2016-05-22', '2016-05-01', '2016-02-14', 'une application web pour la gestion des stages', 'proposer', 'islaib', 'nida madouri', 'asma gharbi', 'Gerer les sujets          Gerer les etudiants et l', 12345678, 7953134, 'uml', 'php', '2015/2016', 'pfe');
