...
<div class="container">
  ...
  <header>
   ...
   <li class="current"><a href="mesproposition.php">mes proposistions</a></li>
...
$sujets =$sujet->affichemesproposition($cin);
 ...
 <?php foreach ($sujets as $key=>$value) : ?>
  <tr><td>  <a href="etudiant.php?id=<?php echo $value['id']?>" target="_blank"><?php echo $value['titre']; ?> </td></a></td>
