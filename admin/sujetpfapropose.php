...
$sujets =$sujet->affichesujetpfapropose();
 ...
 <header>
    <div id="fdw">
        <!--nav-->
          <nav>
            ...
            <li><a href="listedesujetpfa.php">sujet pfa</a></li>
                  ...
                  <li><a  class="subCurrent" href="sujetpfapropose.php">sujet propose </a></li>
            </ul></li>
      ...
      echo $pro[0]; }?> </font> </a></li>
                  <li><a href="listedeencadrant.php">encadremnt</a></li>
                </ul>
...
<td><a href="listedeencadrant.php?id=<?php echo $value['idsujet'];?>&soutenu=oui"onclick="return(confirm('Etes-vous sûr de soutenu ?'));"><img src="../image/soutenir.png" width="35px" height="35px"></a>
