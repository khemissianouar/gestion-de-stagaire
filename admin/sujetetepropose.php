...
$sujets =$sujet->affichesujetetepropose();
...
<div class="container">
 <header>
    <div id="fdw">
        <!--nav-->
          <nav>
              <ul><li class="current"><a href="listedesujetete.php">Stage d'ete</a>
    </li>
 ...
 <?php foreach ($sujets as $key=>$value): ?>
  ...
  <tr><td>  <a href="sujet1.php?id=<?php echo $value['id']?>" target="_blank"><?php echo $value['titre']; ?> </td></a>
		...
		<td>     <a href="sujetetepropose.php?id=<?php echo $value['id'];?>&soutenu=oui"onclick="return(confirm('Etes-vous sûr de soutenu ?'));"><img src="../image/soutenir.png" width="35" height="35"></a></td>
     	</tr>
...
<?php endforeach ;}?>
    ...
    <?php if(isset($_GET['soutenu'])&& $_GET['soutenu']=='oui'){$sujet->soutenuete($_GET['id']);} ?>
