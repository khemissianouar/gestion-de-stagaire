...
$users=$user->afficheetudiantsnonstage();
$spe= new specialitemanager();
 if(isset($_SESSION)){
    ...
    <div id="fdw">
      ...
      echo $pro[0]; }?> </font></a></li>
                  ...
                  <li><a href="listedeencadrant.php">encadrement</a></li>
                   ...
                   <li class="current"><a href="listedeetudiant.php">etudiant<span class="arrow"></span> </a>
                  <ul style="display: none;" class="sub_menu">
                    <li class="arrow_top"></li>
            
               <li><a href="listedeetudiant.php">liste des etudiants </a>
            <li ><a class="subCurrent" href="etudiantnontpasstage.php">etudiant n'ont pas stage</a></li></ul></li>
...
$sql="SELECT * FROM etudiant WHERE cin='".$value['cin']."'";
$req=mysql_query($sql);
$data=mysql_fetch_row($req);
  ?>


  <tr><td>  <a href="etudiant.php?cin=<?php echo $data[0]?>" target="_blank"><?php echo $data[1]; ?> </td></a>
		<td><?php echo $data[2]; ?> </td>

    <td>  <?php     $unspe=$spe->afficheunspecilaite($data[11]);   echo $unspe['specialite'];                                ?> </td>
   </tr>
