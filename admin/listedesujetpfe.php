 ...
 <header>
    <div id="fdw">
      ...
      echo $pro[0]; }?> </font><span class="arrow"></span></a>
                <ul style="display: none;" class="sub_menu">
                  <li class="arrow_top"></li>
                  <li><a class="subCurrent" href="listedesujetpfe.php">sujet PFE</a></li>
                  <li><a href="listedesujetpfepropose.php">sujet propose<font color="red"><?php if ($pro[0]>0){
      echo $pro[0]; }?> </font></a> </a></li>
...
<tbody>
 ...
 ?> </td>
        <td><a href="modefiesujet.php?id=<?php echo $value['id'];?>"><img src="../image/modefie.png" width="40px" height="40px" ></a></td>
 </tr>
...
<?php endforeach ;}?>
         ...
         <a href="ajoutesujetpfe.php"><img src="../image/ajoutesujet.png" width="40px" height="40px"> </a> 
		 </div>
        </div>
</div>
</div>
