...
<div class="container">
 <header>
    <div id="fdw">
      ...
      echo $pro[0]; }?></font> </a></li></a></li>
            ...
            <li><a class="current" href="listedeenseignant.php">enseignant </a></li>       
 ...
 <th>Edition</th>
  <th>Suppression</th>
 </tr> </thead><?php if(!empty($user)){?>
    <?php foreach ($users as $key=>$value): ?>
      <tbody>

	<tr><td><a href="enseignant.php?cin=<?php echo $value['cin']?>" target="_blank"><?php echo $value['nom']; ?> </td>
		<td><?php echo $value['prenom']; ?> </td>
		<td><?php echo $value['grade']; ?> </td>
		<td><?php echo $value['cin']; ?> </td>
		<td><?php echo $value['email'] ; ?> </td>
     <td><?php echo $value['tel']; ?> </td>
     <td><?php echo $value['adresse']; ?> </a></td>
     <td><a href="modefieenseignant.php?cin=<?php echo $value['cin'];?>"><img src="../image/modefie.png" width="40px" height="40px"></a></td>
     <td><a href="listedeenseignant.php?cin=<?php echo $value['cin'];?>&supp=delete"onclick="return(confirm('Etes-vous sûr de vouloir supprimer?'));"><img src="../image/supprime.png"  width="30px" height="30px"> </a></td></tr>
...
<?php endforeach ;}?>
    ...
    <?php if(isset($_GET['supp'])&& $_GET['supp']=='delete'){$user->suppenseignant($_GET['cin']);} ?>

        <a href="inscriptionenseignant.php"><img src="../image/ajoute.png" width="40px" height="40px"></a>
